...
// https://github.com/polytomic/odbc/issues/14
...
// https://github.com/polytomic/odbc/issues/19
...
// https://github.com/polytomic/odbc/issues/20
...
// https://github.com/polytomic/odbc/issues/21
...
// https://github.com/polytomic/odbc/issues/27
...
func TestMSSQLMarkBeginBadConn(t *testing.T) {
	...
	testFn := func(label string, nextFn func(driver.Conn) error) {
		...
		// next operation on the driver connection should return
		// driver.ErrBadConn, or driver.SessionResetter should return driver.ErrBadConn
		// to prevent the bad connection from getting used again.
